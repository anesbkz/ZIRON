...
exports.INITIAL_REWARDS = exports.BADGES = exports.MILESTONES = exports.LEVEL_THRESHOLDS = exports.XP_VALUES = void 0;
exports.calculateLevel = calculateLevel;
exports.calculateStreakUpdate = calculateStreakUpdate;
exports.XP_VALUES = {
...
function calculateLevel(xp) {
    ...
    for (let i = 0; i < exports.LEVEL_THRESHOLDS.length; i++) {
        if (safeXp >= exports.LEVEL_THRESHOLDS[i].minXp) {
            currentTierIndex = i;
        }
        else {
            break;
    ...
    const currentTier = exports.LEVEL_THRESHOLDS[currentTierIndex];
    const isMaxLevel = currentTierIndex === exports.LEVEL_THRESHOLDS.length - 1;
    const nextTier = isMaxLevel ? null : exports.LEVEL_THRESHOLDS[currentTierIndex + 1];
...
function calculateStreakUpdate(currentStreak, longestStreak, lastActivityDate, activityDate) {
    if (!lastActivityDate) {
        return {
            currentStreak: 1,
