 ...
 * - Phase 01: 30 capsules / 30-day supply
 * - Phase 02: 30 capsules / 30-day supply
 * - Phase 03: 30 capsules / 30-day supply
 * - Complete Bundle: 3 x 30 capsules = 90 capsules total
 * 
 * Pricing is configurable via `priceDzd: number | null`.
 * When null, the interface displays a localized "Price to be configured" message.
 */
export const ZIRON_CATALOG: PublicCatalogItem[] = [
  {
    ...
    capsuleCount: 30,
    supplyDays: 30,
    priceDzd: null, // Configurable in DZD via future Admin CMS
