...
const ADMIN_NAV_ITEMS: NavItem[] = [
  ...
  { id: 'admin/products', label: 'Product Catalog', icon: Package, requiredPermission: 'MANAGE_PRODUCTS' },
  { id: 'admin/codes', label: 'Batch Codes & QR', icon: QrCode, requiredPermission: 'MANAGE_CODES' },
